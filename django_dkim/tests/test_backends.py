...
class TestSMTPEmailBackend(SimpleTestCase):
    ...
    def test_email_signed(self, mock_smtp):
        ...
        self.assertTrue(
            dkim.verify(args[2], dnsfunc=lambda *args, **kwargs: DNS_TXT_RECORD)
        )
    ...
    def test_dkim_exception(self, mock_smtp):
        ...
        with self.assertRaises(dkim.DKIMException):
            email = EmailMessage(
                "Subject", "Content", "from@example.com", to=["to@example.com"]
            )
    ...
    def test_email_signed(self):
        ...
        self.assertTrue(
            dkim.verify(
                ...
                dnsfunc=lambda *args, **kwargs: DNS_TXT_RECORD,
            )
        )
